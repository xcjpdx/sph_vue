            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="
                    changeChecked(saleAttr, spuSaleAttr.spuSaleAttrValueList)
                  "
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  class="itxt"
                  :value="skuNum"
                  @change="userInputShopCount($event)"
                />
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a
                  href="javascript:"
                  class="mins"
                  @click="skuNum = --skuNum >= 1 ? skuNum : 1"
                  >-</a
                >
              </div>
              <div class="add">
