<template>
  <div>
    <div class="trade-container">
      ...
      <div class="content">
          ...
          >
            ...
            <span class="place" style="float: right">
              ...
              <a
                ...
                @click="updateUserAddress(index)"
                >修改</a
              >
              <el-popconfirm
                title="确定删除该地址吗?"
                @confirm="removeUserAddress(userAddress.id)"
              >
        ...
        <div class="detail">
          ...
          <ul
            class="list clearFix"
            v-for="detailInfo in detailArrayList"
            :key="detailInfo.skuId"
          >
            <li>
              <img
    ...
    <!-- 地址编辑  -->
    <AddressInfoModel
      :controlAddressShow.sync="controlAddressShow"
      @confirmAddress="clickConfirm"
    />
  </div>
</template>
